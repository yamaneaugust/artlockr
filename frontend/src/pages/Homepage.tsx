...
import { Palette, Shield, DollarSign, Zap, Users, Globe, ArrowRight, CheckCircle } from 'lucide-react'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="text-center max-w-3xl mx-auto">
          <div className="flex items-center justify-center gap-3 mb-6">
            ...
            <h1 className="text-5xl font-bold text-gray-900">ArtLock</h1>
          </div>
          <p className="text-xl text-gray-600 mb-8">
            The marketplace where artists legally sell creative works to AI companies
          </p>
          <p className="text-lg text-gray-500 mb-10 max-w-2xl mx-auto">
            Upload your art, set your terms, get paid automatically. AI companies get
            verified, licensed datasets. Everyone wins.
          </p>
          <div className="flex flex-wrap gap-4 justify-center">
            <Link
              to="/marketplace"
              className="px-8 py-4 bg-violet-600 hover:bg-violet-700 text-white font-semibold rounded-xl transition-colors flex items-center gap-2 shadow-lg shadow-violet-200"
            >
              Browse marketplace
            ...
            <Link
              to="/login"
              className="px-8 py-4 bg-white border-2 border-violet-600 text-violet-600 font-semibold rounded-xl hover:bg-violet-50 transition-colors"
            >
              Get started
            </Link>
          </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 max-w-4xl mx-auto mt-20">
          {[
            ...
            <div key={label} className="text-center">
              <Icon className="h-8 w-8 mx-auto text-violet-500 mb-2" />
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              ...
              {[
                ...
                <div key={step} className="flex gap-4 items-start">
                  <div className="flex-shrink-0 h-8 w-8 rounded-full bg-violet-100 text-violet-700 font-bold flex items-center justify-center text-sm">
                    {step}
                  </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900">For AI Companies</h3>
              </div>
              {[
                ...
                <div key={step} className="flex gap-4 items-start">
                  <div className="flex-shrink-0 h-8 w-8 rounded-full bg-indigo-100 text-indigo-700 font-bold flex items-center justify-center text-sm">
                    {step}
                  </div>
                  <p className="text-gray-700 pt-1">{text}</p>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={title} className="bg-white rounded-2xl border p-6 hover:shadow-lg transition-shadow">
      ...
      <div className="bg-gradient-to-r from-violet-600 to-indigo-600 py-16">
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <p className="text-violet-100 mb-8 text-lg">
            Join the marketplace today. Artists and companies welcome.
          </p>
          <div className="flex flex-wrap gap-4 justify-center">
            <Link
              to="/login"
              className="px-8 py-4 bg-white text-violet-600 font-semibold rounded-xl hover:bg-gray-50 transition-colors shadow-xl"
            >
              Create account
            </Link>
            <Link
              to="/datasets"
              className="px-8 py-4 bg-violet-700 text-white font-semibold rounded-xl hover:bg-violet-800 transition-colors"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <p className="text-sm text-gray-500">
              © 2024 ArtLock. Fair deals for creators.
            </p>
          </div>
        </div>
      </div>
